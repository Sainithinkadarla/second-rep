...
import ubluetooth #importing ublurtooth means micro-bluetooth

ble_msg = "" #this reads our commands through terminal
...
while True:
    ...
    if ble_msg == 'hi':
        ...
        ble.send('laddu')
    if ble_msg == 'red':
        print(ble_msg," command is prompted")
        ble_msg = ""
        red.value(not red.value())
        if red.value():
            print("red led turned on")
            ble.send(("red led turned on"))
        else:
            print("red led turned off")
            ble.send(("red led turned off"))
